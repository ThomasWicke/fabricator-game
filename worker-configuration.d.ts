/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 854bbf0e3d9e66e55183ba368f7eafc3)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	SPRITES: R2Bucket;
	GOOGLE_API_KEY: string;
	ANTHROPIC_API_KEY: string;
	Main: DurableObjectNamespace /* FabricatorServer */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_API_KEY" | "ANTHROPIC_API_KEY">> {}
}

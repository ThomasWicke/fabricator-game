...
- weapon (OMIT unless the thing is for fighting — a spear, axe, cannon, shock prod; a mining pick is a harvester, not a weapon): damage 4-40, reach 40-150 world px, cooldown 0.25-2 seconds. Trade them off: a heavy hammer is high damage, short reach, slow; a long pike is low damage, long reach, quick. Bare hands already do 6 damage on a 0.4s cooldown, so anything worth building beats that somewhere.
- storage (OMIT unless the thing is clearly for holding or hauling — a crate, pannier, silo, depot): capacity 4-40 extra units. On a tool it enlarges the carrier's pack; on a structure it becomes a drop-off point out in the world.
- nourish (STRUCTURES only, OMIT unless it grows or makes food — a farm, greenhouse, mushroom hut, still): rate 1-12 food per minute.
- ward (STRUCTURES only, OMIT unless it is meant to keep creatures away — a fence, totem, floodlight, scarecrow): radius 60-260 world px of ground it keeps quiet.
- seats: 0-2. Only a vehicle someone rides has seats; structures and tools are 0. flavor: one short wry line about your interpretation.

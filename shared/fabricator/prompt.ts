...
- category: "vehicle" moves and can be driven; "structure" is static (speed 0, locomotion "none"); "tool" is small and handheld.
- size: world pixels; w 32-180, h 24-140. A small buggy ~70x40, a big hauler ~140x80.
...
- anchors: 2-8 visible functional parts placed on the body, x/y in [-0.5,0.5] relative to body center. Ground parts (wheel/leg) go along the bottom edge (y around 0.35-0.5), spread left-to-right. Floats go low and wide. Match the sketch's layout when it shows one (e.g. two big circles = two wheels).
